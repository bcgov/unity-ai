...
Configuration is generated at container runtime from environment variables.

### How It Works in Combined Container

1. **Build**: Angular app compiled to static files
2. **Deploy**: Static files served by Flask at `/app/frontend`
3. **Runtime**: `config.json` generated by entrypoint script
